...
public class MoviesRepository {
    ...
    // Added the string query to our function call to allow us to utilize the now-implemented
    // ... search feature
    public void getMovies(int page, String sortBy, String query, final OnGetMoviesCallback callback) {
        ...
        switch (sortBy) {
            // Added this to enable the search feature
            case SEARCH:
                api.getSearchedMovies(BuildConfig.TMDB_API_KEY, LANGUAGE, query, page)
                        .enqueue(call);
                break;
            case TOP_RATED:
